 ...
 */
export type ProductDesignProps = SliceComponentProps<Content.ProductDesignSlice>;
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <div className="flex flex-col text-center md:text-right">
            {slice.primary.left_section.map((card, index) => (
              <div
                key={index}
                className="text-white rounded-lg p-4 shadow-lg h-full flex flex-col justify-between"
              >
                <div>
                  <IoBookmarksOutline className="mx-auto lg:mx-0 lg:ml-auto mb-3" />
          ...
          <div className="flex flex-col text-center md:text-left">
            {slice.primary.right_section.map((card, index) => (
              ...
              >
                <div>
                  <IoBookmarksOutline className="mx-auto lg:mx-0 lg:mr-auto mb-3" />
                  <h3 className="text-xl font-semibold mb-1">
                    <PrismicText field={card.title} />
                  </h3>
                  <p className="text-sm mb-2">
